...
error_log("[REPORTS-API] Authentication successful - enterprise_code: " . 
    (isset($_SESSION['enterprise_code']) ? $_SESSION['enterprise_code'] : 'not set'));
...
if (isset($_REQUEST['all_tables'])) {
    ...
    exit; // Ensure we exit after sending the response
}
