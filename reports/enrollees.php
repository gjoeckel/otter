<?php
ob_start();
require __DIR__ . '/enrollments_data.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="table-responsive">
        ...
        <table id="certificate-data">
            <caption>Enrollees | <?= htmlspecialchars($start) ?> to <?= htmlspecialchars($end) ?></caption>
            <thead>
                <tr>
            ...
            <?php if (empty($filtered)): ?>
                <tr><td colspan="7">No enrollees in this range.</td></tr>
            <?php else: ?>
