...
# Usage: .\scripts\start-srd-testing.ps1
# Token: "mvp local"
...
Write-Host "   Force cache bust: Remove-Item cache-bust-manifest.json; .\scripts\start-srd-testing.ps1" -ForegroundColor White
